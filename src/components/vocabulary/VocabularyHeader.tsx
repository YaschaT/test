  ...
  return (
    <div className="flex flex-wrap items-start justify-between gap-4">
      <div className="flex items-center gap-3">
        <CategoryIcon skill="vocabulary" size={44} />
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Vocabulary</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Build your Japanese word bank step by step.</p>
        </div>
      </div>
      {ctaLabel ? (
