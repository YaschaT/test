    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          aria-label={label}
          aria-pressed={active}
          className={`inline-flex items-center justify-center rounded-lg p-2 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 pointer-coarse:min-h-11 pointer-coarse:min-w-11 ${
