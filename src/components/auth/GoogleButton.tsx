...
export function GoogleButton() {
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2.5 h-11 rounded-xl border border-slate-200 dark:border-slate-700 text-sm font-semibold text-slate-400 dark:text-slate-500 cursor-not-allowed"
    >
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true" className="opacity-60">
