        ...
        {question.options.map((option, i) => {
          ...
          return (
            <button
              ...
              className={`w-full text-left jp-text rounded-xl border px-4 py-2.5 pointer-coarse:py-3.5 text-sm font-medium transition-all flex items-center justify-between gap-2 ${
                showCorrect
