  ...
  },
  {
    ...
    units: [
      unit({
        ...
        readingIds: ['r-my-day', 'r-weekend-plans', 'r-my-town'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
  ...
  },
  {
    ...
    units: [
      unit({
        ...
        objectives: [t('Use everyday N4 nouns (plans, places, interests) in sentences.', 'Alledaagse N4-zelfstandige naamwoorden (plannen, plaatsen, interesses) in zinnen gebruiken.'), t('Keep SRS retention above 80%.', 'SRS-retentie boven 80% houden.')],
        prerequisites: [t('Week 8 gate passed.', 'Week 8-poort gehaald.')],
        vocabIds: ['v-jiyuu', 'v-anzen', 'v-kinchou', 'v-basho', 'v-yotei', 'v-youi', 'v-kyoumi', 'v-youji', 'v-betsu', 'v-ijou'],
        kanjiIds: ['k-shin', 'k-ba-place', 'k-you-use', 'k-i-mind', 'k-mi-flavor'],
        readingIds: ['r-studying-japanese'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
  ...
  },
  {
    ...
    units: [
      unit({
        ...
        readingIds: ['r-promise', 'r-japan-weather', 'r-birthday', 'r-studying-japanese'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
  ...
  // ─────────────────────────── Weeks 15–20 · N3 expansion ───────────────────────────
  {
    ...
    units: [
      unit({
        ...
        vocabIds: ['v-saikin', 'v-kimeru', 'v-erabu', 'v-henka', 'v-fueru', 'v-heru'],
        kanjiIds: ['k-ketsu-decide', 'k-yu-reason', 'k-hen-change', 'k-ka-transform'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
  ...
  },
  {
    ...
    units: [
      unit({
        ...
        vocabIds: ['v-hitsuyou', 'v-riyuu', 'v-junbi', 'v-keikaku', 'v-kakunin'],
        kanjiIds: ['k-hitsu-certain', 'k-you-essential', 'k-yo-beforehand', 'k-tei-fixed'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
  ...
  },
  {
    ...
    units: [
      unit({
        ...
        vocabIds: ['v-setsumei', 'v-sekai', 'v-jouhou', 'v-iken'],
        kanjiIds: ['k-sei-world', 'k-kai-boundary', 'k-jou-feeling', 'k-kei-measure'],
  ...
  },
  {
    ...
    units: [
      unit({
        ...
        vocabIds: ['v-eikyou', 'v-kankei', 'v-tsuzukeru', 'v-gijutsu', 'v-fukuzatsu', 'v-seikou', 'v-shippai', 'v-doryoku'],
        kanjiIds: ['k-kan-connection', 'k-kei-relation'],
        readingIds: ['r-kanji-study', 'r-healthy-life'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
    checkpoint: t('Read "Studying Kanji" and produce 3 ば〜ほど sentences; week-18 quiz ≥ 80%.', 'Lees "Kanji Studeren" en maak 3 ば〜ほど-zinnen; week-18-quiz ≥ 80%.'),
    mixedReview: false,
    gate: gate({ grammarCompletion: 1, vocabMastery: 0.7, kanjiCompletion: 0.7, readingCompletion: 1, minCheckpointAccuracy: 0.8, summary: t('ば〜ほど solid, N3 reading passed, relationship/influence vocab retained, checkpoint ≥ 80%.', 'ば〜ほど vast, N3-leestekst gehaald, relatie/invloed-woorden onthouden, checkpoint ≥ 80%.') }),
  },
  {
    week: 19,
    phase: 'N3',
  ...
  },
  {
    ...
    units: [
      unit({
        ...
        readingIds: ['r-ryuugaku', 'r-kanji-study', 'r-healthy-life', 'r-part-time-job'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
