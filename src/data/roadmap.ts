...
export const ROADMAP: RoadmapWeek[] = [
  ...
  },
  {
    ...
    focus: t('Expansion pending — consolidate N4 vocabulary and kanji so far.', 'Uitbreiding volgt — N4-woorden en kanji tot nu toe consolideren.'),
    prerequisiteWeeks: [8],
    coreMinutesPerDay: CORE,
    stretchMinutesPerDay: STRETCH,
    units: [
  ...
  },
  {
    ...
    focus: t('Expansion pending — planned: あげる/くれる/もらう and te-form giving.', 'Uitbreiding volgt — gepland: あげる/くれる/もらう.'),
    prerequisiteWeeks: [9],
    coreMinutesPerDay: CORE,
    stretchMinutesPerDay: STRETCH,
    units: [
      unit({
        id: 'w10-u1',
        title: t('Giving & receiving (planned)', 'Geven & ontvangen (gepland)'),
        objectives: [t('Distinguish あげる, くれる and もらう.', 'あげる, くれる en もらう onderscheiden.'), t('Maintain the 1/3/7/14/30-day review streak.', 'De review-cyclus 1/3/7/14/30 volhouden.')],
        prerequisites: [t('Week 9 gate passed.', 'Week 9-poort gehaald.')],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
    checkpoint: t('Week-10 checkpoint quiz ≥ 80% (content batch pending).', 'Week-10-checkpoint ≥ 80% (contentbatch volgt).'),
    mixedReview: false,
    gate: gate({ minCheckpointAccuracy: 0.8, summary: t('Checkpoint ≥ 80%; full content lands in the next N4 batch.', 'Checkpoint ≥ 80%; volledige content in de volgende N4-batch.') }),
  },
  {
    week: 11,
    phase: 'N4',
    ...
    focus: t('Expansion pending — planned: できる-form, よう/おう intentions.', 'Uitbreiding volgt — gepland: potentiaalvorm, よう/おう.'),
    ...
    units: [
      unit({
        id: 'w11-u1',
        title: t('Can & let’s (planned)', 'Kunnen & laten we (gepland)'),
        objectives: [t('Form potential verbs.', 'Potentiaalwerkwoorden vormen.'), t('Express intention with the volitional.', 'Voornemen uitdrukken met de wilsvorm.')],
        prerequisites: [t('Week 10 gate passed.', 'Week 10-poort gehaald.')],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
    checkpoint: t('Week-11 checkpoint quiz ≥ 80% (content batch pending).', 'Week-11-checkpoint ≥ 80% (contentbatch volgt).'),
    mixedReview: false,
    gate: gate({ minCheckpointAccuracy: 0.8, summary: t('Checkpoint ≥ 80%; full content lands in the next N4 batch.', 'Checkpoint ≥ 80%; volledige content in de volgende N4-batch.') }),
  },
  {
    ...
    focus: t('Expansion pending — planned: と思う, と言う, plain-form embedding.', 'Uitbreiding volgt — gepland: と思う, と言う.'),
    ...
    units: [
      unit({
        id: 'w12-u1',
        title: t('Thinking & saying (planned)', 'Denken & zeggen (gepland)'),
        objectives: [t('Embed a plain clause with と思う/と言う.', 'Een gewone bijzin inbedden met と思う/と言う.'), t('Keep reading fluency growing via stretch route.', 'Leesvloeiendheid laten groeien via de stretch-route.')],
        prerequisites: [t('Week 11 gate passed.', 'Week 11-poort gehaald.')],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
    checkpoint: t('Week-12 checkpoint quiz ≥ 80% (content batch pending).', 'Week-12-checkpoint ≥ 80% (contentbatch volgt).'),
    mixedReview: false,
    gate: gate({ minCheckpointAccuracy: 0.8, summary: t('Checkpoint ≥ 80%; full content lands in the next N4 batch.', 'Checkpoint ≥ 80%; volledige content in de volgende N4-batch.') }),
  },
  {
    ...
    focus: t('Expansion pending — planned: ている/てある, transitive/intransitive pairs.', 'Uitbreiding volgt — gepland: ている/てある, transitief/intransitief.'),
    ...
    units: [
      unit({
        id: 'w13-u1',
        title: t('States & pairs (planned)', 'Toestanden & paren (gepland)'),
        objectives: [t('Describe ongoing states with ている.', 'Doorlopende toestanden beschrijven met ている.'), t('Pick the right transitive/intransitive verb.', 'Het juiste transitieve/intransitieve werkwoord kiezen.')],
        prerequisites: [t('Week 12 gate passed.', 'Week 12-poort gehaald.')],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
    checkpoint: t('Week-13 checkpoint quiz ≥ 80% (content batch pending).', 'Week-13-checkpoint ≥ 80% (contentbatch volgt).'),
    mixedReview: false,
    gate: gate({ minCheckpointAccuracy: 0.8, summary: t('Checkpoint ≥ 80%; full content lands in the next N4 batch.', 'Checkpoint ≥ 80%; volledige content in de volgende N4-batch.') }),
  },
  {
    ...
    units: [
      unit({
        ...
        grammarIds: ['nakereba-narimasen', 'tara', 'sou-desu', 'nagara'],
  ...
  },
  {
    ...
    focus: t('Expansion pending — planned: 受身 (passive) and 使役 (causative).', 'Uitbreiding volgt — gepland: lijdende en veroorzakende vorm.'),
    ...
    units: [
      unit({
        id: 'w19-u1',
        title: t('Done-to & made-to (planned)', 'Ondergaan & laten doen (gepland)'),
        objectives: [t('Form and use the passive.', 'De lijdende vorm vormen en gebruiken.'), t('Form and use the causative.', 'De veroorzakende vorm vormen en gebruiken.')],
        prerequisites: [t('Week 18 gate passed.', 'Week 18-poort gehaald.')],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
    checkpoint: t('Week-19 checkpoint quiz ≥ 80% (content batch pending).', 'Week-19-checkpoint ≥ 80% (contentbatch volgt).'),
    mixedReview: false,
    gate: gate({ minCheckpointAccuracy: 0.8, summary: t('Checkpoint ≥ 80%; full content lands in the next N3 batch.', 'Checkpoint ≥ 80%; volledige content in de volgende N3-batch.') }),
  },
  {
    week: 20,
    phase: 'N3',
    ...
    units: [
      unit({
        ...
        prerequisites: [t('Weeks 15–18 gates passed.', 'Poorten week 15–18 gehaald.')],
        grammarIds: ['n3-you-ni-naru', 'n3-tame-ni', 'n3-hazu', 'n3-okage-sei', 'n3-ba-hodo', 'n3-ni-yoruto'],
        readingIds: ['r-ryuugaku'],
      }),
    ],
    reviewDaysAfter: REVIEW_CADENCE,
